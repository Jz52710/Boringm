  ...
  <div>
    <el-container>
      ...
      <el-main>
        ...
        <!--web-->
        <div class="rd-box hidden-sm-and-down">
          <div class="rd-top">
            <h1 class="rd-text-top">全球研发</h1>
            <p class="rd-text-con">媒趣在丹麦、美国、德国、新加坡等国家设立了九大全球技术创新中心。<br>目前有逾 1700 名设计专业人才，国际员工占 20%，硕士和博士超过 70%，研发及技术人员达 70% 以上。</p>
          </div>
          <div class="map-box">
        ...
        <!--iPhone-->
        <div class="rd-show-box hidden-md-and-up">
          <div class="rd-show-top">
            <h1 class="rd-text-top">全球研发</h1>
            <p class="rd-show-text-con">媒趣在丹麦、美国、德国、新加坡等国家设立了九大全球技术创新中心。<br>目前有逾 1700 名设计专业人才，国际员工占 20%，硕士和博士超过 70%，研发及技术人员达 70% 以上。</p>
          </div>
          <div class="map-show-box">
            <div class="map" ref="mapmini" style="width: 100%;height: 100%"></div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    mapWorld(){
      ...
      */
      var geoCoordMap = {
        ...
        //一带一路
        '广州': [113.5107, 23.2196],
        '上海': [121.5087890625, 31.297327991404266],
      ...
      series.push({
        ...
        data: [{
          name: '上海',
          value: [121.5087890625, 31.297327991404266, 30],
          label: {
            normal: {
              position: 'right'
            }
      ...
      chart.setOption({
        ...
        geo: {
          ...
          itemStyle: { // 每个区域的样式
            normal: {
              borderColor:'#8ba7d4',//边界线颜色
              areaColor:'#2170b8',//默认区域颜色
              // areaColor: '#7d7d7d'
            },
            emphasis: {
              areaColor: '#8ba7d4'//移动颜色
            }
          },
          regions: [{ // 选中的区域
            name: 'China',
    ...
    //iphone地图
    mapMini(){
      let chart = echarts.init(this.$refs.mapmini);
      /*
          图中相关城市经纬度,根据你的需求添加数据
          关于国家的经纬度，可以用首都的经纬度或者其他城市的经纬度
      */
